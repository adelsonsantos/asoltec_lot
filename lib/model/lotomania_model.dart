...
class LotomaniaModel {
  List<Lotomania> lotomania = [];
  String date = '';
  String error = '';

  LotomaniaModel({required this.lotomania});

  LotomaniaModel.withError(errorMessage) {
    error = errorMessage;
  }

  LotomaniaModel.fromJsonn(List<dynamic> json) {
    lotomania = [];
    for (var v in json) {
      lotomania.add(Lotomania.fromJson(v));
    }
  }
}
...
class Lotomania {
  ...
  Lotomania.fromJson(Map<String, dynamic> json) {
  ...
  Lotomania.withError(errorMessage) {
    error = errorMessage;
  }
}
