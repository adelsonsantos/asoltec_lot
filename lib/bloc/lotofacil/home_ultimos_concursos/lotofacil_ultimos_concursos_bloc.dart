...
part 'lotofacil_ultimos_concursos_state.dart';
part 'lotofacil_ultimos_concursos_event.dart';

class LotofacilUltimosConcursosBloc extends Bloc<LotofacilUltimosConcursosEvent,
    LotofacilUltimosConcursosState> {
  LotofacilUltimosConcursosBloc() : super(Initial()) {
