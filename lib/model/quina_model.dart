...
class QuinaModel {
  ...
  QuinaModel({required this.quina});

  QuinaModel.withError(errorMessage) {
    error = errorMessage;
  }

  QuinaModel.fromJsonn(List<dynamic> json) {
    quina = [];
    for (var v in json) {
      quina.add(Quina.fromJson(v));
    }
  }
}
...
class Quina {
  ...
  Quina.fromJson(Map<String, dynamic> json) {
